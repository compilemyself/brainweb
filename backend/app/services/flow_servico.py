...
class FlowServico:
    ...
    def salvar_flow(self, mapa_id: int, dados: FlowSchema):
        # apagar arestas antes dos nodes evita conflito de FK
        self._repo.apagar_edges(mapa_id)
        self._repo.apagar_nodes(mapa_id)

        id_map = {}

        # recria nodes e guarda o mapeamento:
        # id antigo do React Flow -> id real do PostgreSQL
        ...
        # recria edges usando os ids reais recém-criados
